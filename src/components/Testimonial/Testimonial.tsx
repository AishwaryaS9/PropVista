...
const Testimonial = () => {
    const testimonials = [
        {
            text: "PropVista helped me find my dream home within weeks! The platform is intuitive and the options are fantastic.",
            name: "Emily Johnson",
            role: "Homeowner",
        },
        {
            text: "As a realtor, PropVista has been a game-changer for connecting with clients and showcasing properties.",
            name: "James Carter",
            role: "Realtor",
        },
        {
        ...
        {
            text: "Finding commercial spaces for my business was a breeze with PropVista. Highly recommend it!",
            name: "Chloe Anderson",
            role: "Business Owner",
        },
        {
        ...
        {
            text: "PropVista offers the best database of properties. Everything is so well organized and easy to search.",
            name: "Ethan Wilson",
